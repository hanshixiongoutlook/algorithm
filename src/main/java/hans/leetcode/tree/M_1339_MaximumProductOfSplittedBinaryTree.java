...
public class M_1339_MaximumProductOfSplittedBinaryTree {
    ...
    /**
     * 			Runtime:10 ms, faster than 42.97% of Java online submissions.
     * 			Memory Usage:54.1 MB, less than 55.90% of Java online submissions.
     * @param root
     * @return
     */
    ...
    public long dfs(TreeNode root) {
        ...
        max = Math.max(sum*(totalSum-sum), max);
        return sum;
    }
